...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    description:
      'We are seeking a creative UX/UI Designer to join our design team. You will be responsible for creating intuitive and beautiful user experiences.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Join our data science team to build machine learning models and extract insights from large datasets. You will work on exciting projects that drive business decisions.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Contract position for an experienced mobile developer to work on iOS and Android applications. 6-month contract with possibility of extension.',
    requirements: [
  ...
  },
  {
    ...
    description:
      'Join our startup as a Frontend Developer and help build the next generation of web applications. You will work in a fast-paced environment with modern technologies.',
    requirements: [
